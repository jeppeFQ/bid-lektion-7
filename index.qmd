...
* Før UML eksisterede, havde forskellige virksomheder og udviklere deres egne måder at tegne softwarediagrammer på. Det var lidt som hvis hvert land havde sit eget alfabet. Det fungerede fint internt, men når folk skulle samarbejde på tværs af organisationer, opstod der forvirring. Betyder denne firkant en klasse eller en proces? Er dette en arv eller en afhængighed?

I 1997 blev UML en international standard vedtaget af Object Management Group. Det betyder at når du lærer UML, lærer du et sprog der genkendes af udviklere over hele verden. En udvikler i Japan kan se dit UML diagram og forstå det, selvom I ikke taler det samme programmeringssprog eller menneskelige sprog.

UML er meget omfattende og indeholder faktisk fjorten forskellige diagramtyper. Vis skal (kun) se på:
